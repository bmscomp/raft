# Chapter 12: Case Study — Replicated Counter with Full Cluster Simulation
...
*Next: [Chapter 13 — Case Study: Distributed Transactions](13-case-distributed-transactions.md) tackles the hardest problem yet — multi-key atomic operations with optimistic concurrency control and serializable isolation.*
