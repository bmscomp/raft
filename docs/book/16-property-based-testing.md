# Chapter 16: Property-Based Testing for Raft
...
*Next: [Chapter 17 — Multi-Raft Group Design](17-multi-raft-groups.md) discusses how to scale beyond a single Raft group to handle larger datasets and higher throughput.*
